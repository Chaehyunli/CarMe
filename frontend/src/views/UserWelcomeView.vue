...
interface ChatResponse { result_status: "GROUNDED" | "CLARIFYING" | "INSUFFICIENT_EVIDENCE" | "SAFETY_ESCALATION"; answer?: string; citations: Citation[]; escalation?: string; }
interface Message { role: "user" | "assistant"; text: string; citations?: Citation[]; }
...
async function ask(): Promise<void> {
  ...
  try {
    ...
    messages.value.push({ role: "assistant", text: result.answer || result.escalation || "답변을 준비하지 못했습니다.", citations: result.citations });
